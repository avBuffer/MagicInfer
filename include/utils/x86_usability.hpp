...
static MAGIC_FORCEINLINE signed char float2int8(float v) 
{
...
#if __SSE2__
static MAGIC_FORCEINLINE float _mm_reduce_add_ps(__m128 x128) 
{
...
static MAGIC_FORCEINLINE float _mm_reduce_max_ps(__m128 x128) 
{
...
static MAGIC_FORCEINLINE int _mm_reduce_add_epi32(__m128i x) 
{
...
static MAGIC_FORCEINLINE int32_t float2int8_sse(const __m128 &_v0) 
{
...
static MAGIC_FORCEINLINE int64_t float2int8_sse(const __m128 &_v0, const __m128 &_v1) 
{
    // _MM_ROUND_NEAREST round to even
    // simulate round to nearest via +/-0.5 with round to zero
    __m128 _p5 = _mm_set1_ps(0.5f);
...
static MAGIC_FORCEINLINE __m128i float2int8_sse(const __m128 &_v0, const __m128 &_v1, const __m128 &_v2, const __m128 &_v3) 
{
    // _MM_ROUND_NEAREST round to even
    // simulate round to nearest via +/-0.5 with round to zero
    __m128 _p5 = _mm_set1_ps(0.5f);
...
#ifndef __FMA__
static MAGIC_FORCEINLINE __m128 _mm_comp_fmadd_ps(const __m128& _a, const __m128& _b, const __m128& _c)
{
    return _mm_add_ps(_mm_mul_ps(_a, _b), _c);
}

static MAGIC_FORCEINLINE __m128 _mm_comp_fnmadd_ps(const __m128& _a, const __m128& _b, const __m128& _c)
{
...
#if __AVX__
#ifndef __FMA__
static MAGIC_FORCEINLINE __m256 _mm256_comp_fmadd_ps(const __m256& _a, const __m256& _b, const __m256& _c)
{
    return _mm256_add_ps(_mm256_mul_ps(_a, _b), _c);
}

static MAGIC_FORCEINLINE __m256 _mm256_comp_fnmadd_ps(const __m256& _a, const __m256& _b, const __m256& _c)
{
...
static MAGIC_FORCEINLINE __m256 _mm256_fmadd_1_ps(const __m256 &a, const __m256 &b, float c) 
{
    return _mm256_comp_fmadd_ps(b, _mm256_set1_ps(c), a);
}


static MAGIC_FORCEINLINE __m256 _mm256_fmrsub_1_ps(const __m256 &a, const __m256 &b, float c) 
{
    // return a - b * c
...
static MAGIC_FORCEINLINE void transpose8x12_ps(__m256 &_r0, __m256 &_r1, __m256 &_r2, __m256 &_r3, 
    __m256 &_r4, __m256 &_r5, __m256 &_r6, __m256 &_r7, __m256 &_r8, __m256 &_r9, __m256 &_ra, __m256 &_rb) 
{
...
static MAGIC_FORCEINLINE void transpose8x8_ps(__m256 &_r0, __m256 &_r1, __m256 &_r2, 
    __m256 &_r3, __m256 &_r4, __m256 &_r5, __m256 &_r6, __m256 &_r7) 
{
    __m256 _tmp0 = _mm256_unpacklo_ps(_r0, _r1);
    __m256 _tmp1 = _mm256_unpackhi_ps(_r0, _r1);
    __m256 _tmp2 = _mm256_unpacklo_ps(_r2, _r3);
...
static MAGIC_FORCEINLINE void transpose8x4_ps(__m256 &_r0, __m256 &_r1, __m256 &_r2, __m256 &_r3) 
{
    __m256 _tmp0 = _mm256_unpacklo_ps(_r0, _r1);
    __m256 _tmp1 = _mm256_unpackhi_ps(_r0, _r1);
    __m256 _tmp2 = _mm256_unpacklo_ps(_r2, _r3);
...
static MAGIC_FORCEINLINE void transpose8x2_ps(__m256 &_r0, __m256 &_r1) 
{
    __m256 _tmp0 = _mm256_unpacklo_ps(_r0, _r1);
    __m256 _tmp1 = _mm256_unpackhi_ps(_r0, _r1);
...
static MAGIC_FORCEINLINE void transpose8x8_epi16(__m128i &_r0, __m128i &_r1, __m128i &_r2, 
    __m128i &_r3, __m128i &_r4, __m128i &_r5, __m128i &_r6,  __m128i &_r7) 
{
...
static MAGIC_FORCEINLINE __m256 HorizontalSums(__m256 &v0, __m256 &v1, __m256 &v2, 
    __m256 &v3, __m256 &v4, __m256 &v5, __m256 &v6, __m256 &v7) 
{
...
static MAGIC_FORCEINLINE __m128 HorizontalSums(__m256 &v0, __m256 &v1, __m256 &v2, __m256 &v3) 
{
    const __m256 s01 = _mm256_hadd_ps(v0, v1);
    const __m256 s23 = _mm256_hadd_ps(v2, v3);
    const __m256 s0123 = _mm256_hadd_ps(s01, s23);
...
static MAGIC_FORCEINLINE __m128 HorizontalSums(__m256 &v0, __m256 &v1, __m256 &v2) 
{
...
static MAGIC_FORCEINLINE float _mm256_reduce_add_ps(__m256 x) 
{
...
static MAGIC_FORCEINLINE float _mm256_reduce_max_ps(__m256 x) 
{
...
static MAGIC_FORCEINLINE int64_t float2int8_avx(const __m256 &_v0) 
{
...
static MAGIC_FORCEINLINE __m128i float2int8_avx(const __m256 &_v0, const __m256 &_v1) 
{
    // _MM_FROUND_TO_NEAREST_INT round to even
    // simulate round to nearest via +/-0.5 with round to zero
    __m256 _p5 = _mm256_set1_ps(0.5f);
...
static MAGIC_FORCEINLINE void _mm256_comp_fmadd_ps4(__m256 &_sum, const __m256 &_w0, const __m256 &_w1,
    const __m256 &_w2, const __m256 &_w3, const __m256 &_v0, const __m256 &_v1, const __m256 &_v2, const __m256 &_v3) 
{
...
static MAGIC_FORCEINLINE void _mm256_comp_fmadd_ps8(__m256 &_sum, const __m256 &_w0, const __m256 &_w1, const __m256 &_w2,
    const __m256 &_w3, const __m256 &_w4, const __m256 &_w5, const __m256 &_w6, const __m256 &_w7, const __m256 &_v0,
    const __m256 &_v1, const __m256 &_v2, const __m256 &_v3, const __m256 &_v4, const __m256 &_v5, const __m256 &_v6, const __m256 &_v7) 
{
...
#if __AVX512F__
static MAGIC_FORCEINLINE void transpose16x16_ps(__m512 &_r0, __m512 &_r1, __m512 &_r2, __m512 &_r3,
    __m512 &_r4, __m512 &_r5, __m512 &_r6, __m512 &_r7, __m512 &_r8, __m512 &_r9, __m512 &_ra, __m512 &_rb,
    __m512 &_rc, __m512 &_rd, __m512 &_re, __m512 &_rf) 
{
...
static MAGIC_FORCEINLINE void transpose16x12_ps(__m512 &_r0, __m512 &_r1, __m512 &_r2, __m512 &_r3,
    __m512 &_r4, __m512 &_r5, __m512 &_r6, __m512 &_r7, __m512 &_r8, __m512 &_r9, __m512 &_ra, __m512 &_rb) 
{
    __m512 _tmp0 = _mm512_unpacklo_ps(_r0, _r1);
    __m512 _tmp1 = _mm512_unpackhi_ps(_r0, _r1);
...
static MAGIC_FORCEINLINE void transpose16x8_ps(__m512 &_r0, __m512 &_r1, __m512 &_r2, 
    __m512 &_r3, __m512 &_r4, __m512 &_r5, __m512 &_r6, __m512 &_r7)
{
    __m512 _tmp0 = _mm512_unpacklo_ps(_r0, _r1);
    __m512 _tmp1 = _mm512_unpackhi_ps(_r0, _r1);
    __m512 _tmp2 = _mm512_unpacklo_ps(_r2, _r3);
...
static MAGIC_FORCEINLINE void transpose16x4_ps(__m512 &_r0, __m512 &_r1, __m512 &_r2, __m512 &_r3) 
{
    __m512 _tmp0 = _mm512_unpacklo_ps(_r0, _r1);
    __m512 _tmp1 = _mm512_unpackhi_ps(_r0, _r1);
    __m512 _tmp2 = _mm512_unpacklo_ps(_r2, _r3);
...
static MAGIC_FORCEINLINE void transpose16x2_ps(__m512 &_r0, __m512 &_r1) 
{
    __m512 _tmp0 = _mm512_unpacklo_ps(_r0, _r1);
    __m512 _tmp1 = _mm512_unpackhi_ps(_r0, _r1);
...
static MAGIC_FORCEINLINE void transpose8x16_ps(__m256 &_r0, __m256 &_r1, __m256 &_r2, __m256 &_r3, 
    __m256 &_r4, __m256 &_r5, __m256 &_r6, __m256 &_r7, __m256 &_r8, __m256 &_r9, __m256 &_ra,
    __m256 &_rb, __m256 &_rc, __m256 &_rd, __m256 &_re, __m256 &_rf) 
{
    __m256 _tmp0 = _mm256_unpacklo_ps(_r0, _r1);
    __m256 _tmp1 = _mm256_unpackhi_ps(_r0, _r1);
    __m256 _tmp2 = _mm256_unpacklo_ps(_r2, _r3);
...
static MAGIC_FORCEINLINE void transpose16x16_epi16(__m256i &_r0, __m256i &_r1, __m256i &_r2, __m256i &_r3,
    __m256i &_r4, __m256i &_r5, __m256i &_r6, __m256i &_r7, __m256i &_r8, __m256i &_r9,
    __m256i &_ra, __m256i &_rb, __m256i &_rc, __m256i &_rd, __m256i &_re, __m256i &_rf) 
{
...
static MAGIC_FORCEINLINE void transpose16x8_epi16(__m256i &_r0, __m256i &_r1, __m256i &_r2, 
    __m256i &_r3, __m256i &_r4, __m256i &_r5, __m256i &_r6, __m256i &_r7) 
{
    __m256i _tmp0 = _mm256_unpacklo_epi16(_r0, _r1);
    __m256i _tmp1 = _mm256_unpackhi_epi16(_r0, _r1);
    __m256i _tmp2 = _mm256_unpacklo_epi16(_r2, _r3);
...
static MAGIC_FORCEINLINE float _mm512_comp_reduce_add_ps(__m512 x) 
{
...
static MAGIC_FORCEINLINE float _mm512_comp_reduce_max_ps(__m512 x) 
{
